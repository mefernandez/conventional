...
public class CommonConventionsProvider {
	
	private Map<Class, Convention<?>> defaultValuesRegistry = new HashMap<Class, Convention<?>>();
	
	public CommonConventionsProvider() {
		// Primitive Types
		/*
		...
		*/
		...
		defaultValuesRegistry.put(String.class, new MethodNameStringConvention());
		/*
